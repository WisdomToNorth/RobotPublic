    ...
    foreach (icon ${ARG_ICONS})
        ...
        if (APPLE)
            if (${icon_type} STREQUAL ".icns")
                set(icon_full_output ${CMAKE_BINARY_DIR}/${icon_name}.icns)
        ...
        if (${icon_type} STREQUAL ".ico")
            set(icon_full_output ${CMAKE_BINARY_DIR}/${icon_name}.ico)
            configure_file(${icon_full} ${icon_full_output} COPYONLY)
            file(WRITE "${CMAKE_BINARY_DIR}/${icon_name}.rc.in" "IDI_ICON1        ICON        DISCARDABLE    \"${icon_name}.ico\"\n")
            add_custom_command(
                    OUTPUT "${icon_name}.rc"
