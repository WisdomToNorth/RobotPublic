...
#pragma once
#ifndef RF_PROPERTY_GENERIC_H
#define RF_PROPERTY_GENERIC_H
...
template <typename T>
class GenericScalarProperty : public GenericProperty<T>, public PropertyScalarConstraints<T>
{
public:
    using ValueType = T;
    GenericScalarProperty(PropertyGroup *grp, const TextId &name);
    GenericScalarProperty(PropertyGroup *grp, const TextId &name, T minimum, T maximum,
                          T singleStep);
};

class BasePropertyQuantity : public Property, public PropertyScalarConstraints<double>
{
public:
    ...
    inline static const char TypeName[] = "rfapp::BasePropertyQuantity";
    const char *dynTypeName() const override
    {
...
template <typename T>
GenericScalarProperty<T>::GenericScalarProperty(PropertyGroup *grp, const TextId &name, T minimum,
                                                T maximum, T singleStep)
    : GenericProperty<T>(grp, name)
