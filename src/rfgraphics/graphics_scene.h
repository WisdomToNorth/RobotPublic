...
public:
    ...
    void addObject(const GraphicsObjectPtr &object,
                   AddObjectFlags flags = AddObjectFlag::AddObjectDefault);
    ...
    void highlightObject(const GraphicsObjectPtr &object, bool on);
    ...
    void setObjSelectionMode(const GraphicsObjectPtr &_model, int select_flag);
...
template <typename Function>
void GraphicsScene::foreachOwner(const GraphicsObjectPtr &object, int selectionMode,
                                 Function fn) const
{
